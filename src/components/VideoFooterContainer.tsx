        ...
        <div className="relative flex flex-col justify-center items-center text-white pb-[200px] text-2xl leading-6 z-20 lg:text-xl lg:leading-6 md:text-lg xs:text-base">
          ...
          {registration && (
            <a
              ...
              className="bg-gradient-orange whitespace-nowrap text-lg font-medium text-white px-[60px] py-[20px] lg:px-[50px] lg:py-[18px] md:px-[40px] md:py-[16px] sm:px-[30px] sm:py-[14px] transition ease-in-out delay-1500 hover:-translate-y-1 hover:scale-110 rounded-customv"
            >
              {registration}
            </a>
          )}
