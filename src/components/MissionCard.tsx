      ...
      <div className="flex flex-col lg:flex-row w-full bg-heise-black border border-solid border-baclavas">
        <div className="relative flex-1 p-[30px] flex-col pr-10 xl:p-[30px] xs:px-[10px]">
          ...
          <div className="w-auto">
            <Badge variant="malicious" label="Risk Assessment" />
          </div>
          ...
          <p className="font-inter text-lg leading-[26px] text-chrome">
            ...
            surrounding region, offering insights into the latest advancements
            and showcasing the newest products.
          </p>
        </div>
        ...
        <div className="relative flex-1 p-[30px] xl:p-[30px] xs:px-[10px] flex-col pr-10">
          ...
          <div className="w-auto">
            <Badge variant="low" label="Attack Surface" />
          </div>
          ...
          <p className="font-inter text-lg leading-[26px] text-chrome">
            Provide a platform for companies that develop and offer
            cybersecurity products or services to showcase their offerings,
            network, and attract new business opportunities.
          </p>
        </div>

        <div className="relative flex-1 p-[30px] xl:p-[30px] xs:px-[10px] flex-col pr-10s">
          <div className="w-auto">
            <Badge variant="clean" label="Security Posture" />
          </div>
